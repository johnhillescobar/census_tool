...
def _validate_expectation(
    ...
    if (
        expectation.temporal_status is not None
        and result.temporal_status != expectation.temporal_status
    ):
        raise AssertionError(
    ...
    if (
        expectation.benchmark_status is not None
        and result.benchmark_status != expectation.benchmark_status
    ):
        raise AssertionError(
